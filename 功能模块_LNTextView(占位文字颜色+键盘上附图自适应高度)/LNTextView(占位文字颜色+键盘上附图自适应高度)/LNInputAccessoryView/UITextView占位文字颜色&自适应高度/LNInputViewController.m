...
#import "LNInputViewController.h"
...
@interface LNInputViewController ()<UITextViewDelegate>
...
@implementation LNInputViewController
...
- (void)setupInputView
{
    ...
    // 设置文本框占位文字
    self.textView.placeholder = @"Public_不知名开发者";
